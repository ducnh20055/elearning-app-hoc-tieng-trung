import { ConversationScenario, vietnameseText } from "@/constants/CourseData";
import { Colors } from "@/constants/theme";
import { useAuth } from "@/ctx/AuthContext";
import { recordLearningEvent } from "@/lib/learningActivity";
...
const ORANGE = "#FF8800";
const ORANGE_DARK = "#D96B00";
const WARM_BACKGROUND = "#FFF8F2";
...
export default function ConversationMode({
  ...
  const handleRecordToggle = async () => {
    ...
    try {
      ...
      if (user) {
        ...
        void recordLearningEvent(user.id, { type: "conversation_turn" });
      }
    } catch (err) {
  ...
  return (
    <>
      <KeyboardAvoidingView
        style={{ flex: 1, backgroundColor: WARM_BACKGROUND }}
        behavior="padding"
      ...
      >
        ...
        >
          ...
          <View style={styles.headerContent}>
            ...
            <ThemedText style={{ fontSize: 12, color: MUTED }}>
              Mục tiêu: {vietnameseText(scenario.goal)}
            </ThemedText>
          </View>
        ...
        >
          ...
          <View
            style={[styles.textInputWrapper, { backgroundColor: "#FFFFFF" }]}
          >
            <TextInput
              style={[styles.textInput, { color: CHARCOAL }]}
      ...
      >
        <View style={styles.modalOverlay}>
          ...
          >
            ...
            <ThemedText style={styles.completeSubtitle}>
              Làm tốt lắm! Bạn đã hoàn thành hội thoại.
            </ThemedText>
            <TouchableOpacity
              onPress={() => {
        ...
        <ConfettiCannon
          ...
          fallSpeed={4000}
          explosionSpeed={350}
          colors={[ORANGE, "#ff6b35", "#FFD700", "#34C759", "#FF9F0A"]}
        />
      </Modal>
    </>
  );
...
const styles = StyleSheet.create({
  ...
  modalOverlay: {
    flex: 1,
    backgroundColor: "rgba(75, 75, 75, 0.68)",
    justifyContent: "center",
    alignItems: "center",
    padding: 20,
  },
