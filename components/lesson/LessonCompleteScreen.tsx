import { vietnameseText } from "@/constants/CourseData";
...
export default function LessonCompleteScreen({
  ...
  const getPerformanceMessage = () => {
    if (lessonStats.accuracy >= 90) return "Xuất sắc! 🌟";
    if (lessonStats.accuracy >= 75) return "Làm tốt lắm! 🎉";
    if (lessonStats.accuracy >= 60) return "Cố gắng rất tốt! 💪";
    return "Tiếp tục luyện tập nhé! 📚";
  };
      ...
      >
        ...
        >
          ...
          <View style={styles.accuracyText}>
            ...
            >
              {lessonStats.correctAnswers}/{lessonStats.totalQuestions} câu đúng
            </ThemedText>
          </View>
        </Animated.View>
        ...
        {lessonStats.wrongQuestions &&
          lessonStats.wrongQuestions.length > 0 && (
            <Animated.View style={[styles.wrongSection, { opacity: fadeAnim }]}>
              ...
              >
                Tập trung vào các câu này để tiến bộ hơn
              </ThemedText>
                ...
                >
                  ...
                  <View style={styles.questionContent}>
                    <ThemedText style={styles.questionEnglish}>
                      {vietnameseText(question.english)}
                    </ThemedText>
