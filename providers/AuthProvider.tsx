...
import {PropsWithChildren, use, useState, useEffect} from "react";
...
export default function AuthProviders({children}: PropsWithChildren) {
  ...
  const preniumExpiresAt:string | null = profile?.prenium_expires_at ?? null
  const isPrenium = !!profile?.is_prenium &&
