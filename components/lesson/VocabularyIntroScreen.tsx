  ...
  return (
    <View style={styles.container}>
      <ConfirmDialog
        ...
        description="Bạn có chắc muốn thoát không? Tiến độ sẽ bị mất."
        cancelLabel="Hủy"
        confirmLabel="Thoát"
        destructive
      ...
      <View style={styles.content}>
        <View style={styles.instructionContainer}>
          ...
          <ThemedText style={styles.instructionText}>
            Chạm để lật thẻ. Hãy ôn lại những thẻ bạn chưa nhớ.
          </ThemedText>
        </View>
        ...
        <View style={styles.bottomActions}>
          <View style={styles.gradeButtons}>
            ...
            >
              <ThemedText style={styles.gradeButtonText}>Ôn lại</ThemedText>
            </Pressable>
            <Pressable
